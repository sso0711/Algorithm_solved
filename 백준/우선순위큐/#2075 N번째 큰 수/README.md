# <img width="20px"  src="https://d2gd6pc034wcta.cloudfront.net/tier/8.svg" class="solvedac-tier"> [N번째 큰 수](https://www.acmicpc.net/problem/2075) 

| 제출 번호 | 닉네임 | 채점 결과 | 메모리 | 시간 | 언어 | 코드 길이 |
|---|---|---|---|---|---|---|
|101595920|qkrthdud6755|맞았습니다!! |35508KB|812ms|Python 3|477B|

# <img width="20px"  src="https://d2gd6pc034wcta.cloudfront.net/tier/11.svg" class="solvedac-tier"> [선수과목 (Prerequisite)](https://www.acmicpc.net/problem/14567) 

| 제출 번호 | 닉네임 | 채점 결과 | 메모리 | 시간 | 언어 | 코드 길이 |
|---|---|---|---|---|---|---|
|96302063|qkrthdud6755|맞았습니다!! |51340KB|740ms|Python 3|821B|

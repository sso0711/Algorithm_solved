# <img width="20px"  src="https://d2gd6pc034wcta.cloudfront.net/tier/13.svg" class="solvedac-tier"> [내리막 길](https://www.acmicpc.net/problem/1520) 

| 제출 번호 | 닉네임 | 채점 결과 | 메모리 | 시간 | 언어 | 코드 길이 |
|---|---|---|---|---|---|---|
|97956024|qkrthdud6755|맞았습니다!! |45016KB|112ms|Python 3|559B|

# <img width="20px"  src="https://d2gd6pc034wcta.cloudfront.net/tier/10.svg" class="solvedac-tier"> [점프](https://www.acmicpc.net/problem/1890) 

| 제출 번호 | 닉네임 | 채점 결과 | 메모리 | 시간 | 언어 | 코드 길이 |
|---|---|---|---|---|---|---|
|98478677|qkrthdud6755|맞았습니다!! |32412KB|36ms|Python 3|953B|

# <img width="20px"  src="https://d2gd6pc034wcta.cloudfront.net/tier/6.svg" class="solvedac-tier"> [셀프 넘버](https://www.acmicpc.net/problem/4673) 

| 제출 번호 | 닉네임 | 채점 결과 | 메모리 | 시간 | 언어 | 코드 길이 |
|---|---|---|---|---|---|---|
|98550303|qkrthdud6755|맞았습니다!! |33432KB|208ms|Python 3|536B|
